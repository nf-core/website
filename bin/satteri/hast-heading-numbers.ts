...
// Prepends section numbers to headings. Only included in the pipeline of documents
// that opt in via markdownPlugin: addNumbersToHeadings — see markdownConfig.ts.
//
...
// Factory so the counters reset between documents.
export function headingNumbersPlugin() {
