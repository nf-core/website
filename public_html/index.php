    ...
    <div id="features" class="container homepage-feature-boxes">
      <div class="row">
        <div class="col-md-4 mb-5">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-left">Documentation</h5>
        ...
        <div class="col-md-4 mb-5">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-left">CI Testing</h5>
              <img class="float-right ml-2" height="90px" src="assets/img/github-actions.svg" />
        ...
        <div class="col-md-4 mb-5">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-left">Stable Releases</h5>
        ...
        <div class="col-md-4 mb-5">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-left">Docker</h5>
        ...
        <div class="col-md-4 mb-5">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-left">Singularity</h5>
        ...
        <div class="col-md-4 mb-5">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-left">Bioconda</h5>
