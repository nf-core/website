...
<div class="container container-xl">
    ...
    <button class="btn btn-outline-info float-end ms-2 mb-2" data-bs-toggle="collapse" href="#page_help"><i class="fas fa-question-circle me-1"></i> Help</button>
    ...
    if (!$cache) { ?>
        ...
        <form method="get" action="" class="row mb-2">
            <div class="col-3">
                <input type=" text" class="form-control" name="id" placeholder="Build ID">
            </div>
            <button type="submit" class="btn btn-primary col-1">Load</button>
        </form>
        ...
        <form method="post" action="">
            ...
            <div class="form-group">
                ...
                <textarea name="schema" id="schema_input" class="form-control font-monospace small" rows=12>
{
        ...
        <div class="row align-items-center">
            <div class="col">
                <div class="btn-group me-3" role="group">
                    <button class="btn btn-outline-secondary add-param-btn"><i class="fas fa-plus-square me-1"></i> Add parameter</button>
                    <button class="btn btn-outline-secondary add-group-btn"><i class="fas fa-folder-plus me-1"></i> Add group</button>
                </div>
                <div class="btn-group me-3" role="group">
                    <button class="btn btn-outline-secondary collapse-groups-btn"><i class="fas fa-folder me-1"></i> Collapse groups</button>
                    <button class="btn btn-outline-secondary expand-groups-btn"><i class="fas fa-folder-open me-1"></i> Expand groups</button>
                </div>
                <button class="btn btn-outline-secondary to-top-btn schema-panel-btn" data-target="#schema-builder"><i class="fas fa-arrow-to-top me-1"></i> Back to top</button>
            </div>
            <div class="col-auto">
                <button class="btn btn-primary schema-panel-btn" data-target="#schema-finished"><i class="fas fa-check-square me-1"></i> Finished</button>
            </div>
        </div>
    </div>
        ...
        <div class="card mb-5">
            <div class="card-body">
                ...
                <p class="text-center"><button class="btn btn-outline-secondary copy-schema-btn">
                        <i class="far fa-copy me-2"></i> Copy pipeline schema
                    </button>
                <p>
                <p class="text-center"><button class="btn btn-outline-secondary back-to-editor-btn schema-panel-btn" data-bs-target="#schema-builder">
                        <i class="fas fa-brackets-curly me-2"></i> Back to editor
                    </button></p>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="col-auto me-auto ps-0">
                        <button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal" id="settings_delete"><i class="fas fa-trash-alt me-1"></i> <span>Delete parameter</span></button>
                    </div>
                    <div class="col-auto pe-0">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-primary float-right" data-bs-dismiss="modal" id="settings_save">Save changes</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs">
                                <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#tab-helptext">Write</a></li>
                                <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab-helptext-preview">Preview</a></li>
                            </ul>
                        </div>
...
<span class="helptext-preview-helptext text-muted"></span></pre>
                                <p>Website:</p>
                                <div class="card helptext-htms-preview">
                                    <div class="card-body">
                ...
                <div class="modal-footer">
                    <div class="col-auto ms-auto">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" id="help_text_save">Save</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="toast" id="schema_copied" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header">
            <img src="/assets/img/logo/nf-core-logo-square.png" class="rounded me-2" alt="">
            <strong class="me-auto">Schema copied!</strong>
