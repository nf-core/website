...
<p><a href="https://www.dfg.de/en/service/press/press_releases/2018/press_release_no_06/index.html">The German Funding Body (DFG)</a> for establishing four national high-throughput sequencing centers has started to rely on nf-core pipelines for analyzing large-scale genomics data. Contributors from Kiel and Tübingen already actively contributed to the project, the other sequencing centers in Cologne/Bonn (West German Genome Center) and the Dresden Center are in the process of joining and contributing their expertise.</p>
