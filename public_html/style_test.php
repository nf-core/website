<?php
// Don't render test page in production
if ($protocol . $_SERVER['HTTP_HOST'] != "localhost:8888") {
    header('HTTP/1.1 404 Not Found');
    include('404.php');
    die();
};
$title = 'nf-core test page';
$subtitle = 'Testing all the nf-core styles';
$markdown_fn = './test.md';
include('../includes/header.php');
?>
<!-- Taken from https://bootswatch.com/default/ 
