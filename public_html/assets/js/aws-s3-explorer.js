...
$(function () {
    ...
    function folder2breadcrumbs(data) {
        ...
        if (data.params.Prefix) {
            parts.push.apply(parts, data.params.Prefix.endsWith('/') ? data.params.Prefix.slice(0, -1).split('/') : data.params.Prefix.split('/'));
        }
                ...
                fetch(url).then(function (response) {
                    ...
                    response.text().then(function (data) {
                        ...
                        if (![".html", ".pdf", ".png", ".jpg", ".jpeg"].includes(extension)) {
                            ...
                            data = '<iframe src="/s3=?'+url+'" style="border:none; width:100%; height:1000px;"></iframe>';
