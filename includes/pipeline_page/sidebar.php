        ...
        <div class="col-12">
            ...
            <div class="tab-content mt-2">
                ...
                <div class="tab-pane" id="tw" role="tabpanel" aria-labelledby="tw-tab">
                    <div class=" input-group input-group-sm pipeline-run-cmd">
                        <input type="text" class="form-control input-sm code  rounded-0" id="pipeline-tw-run-cmd-text" data-autoselect="" value="tw launch https://pipelines.tol.sanger.ac.uk/<?php echo $pipeline->name .
                            $release_cmd; ?>" aria-label="Copy run command" readonly="">
