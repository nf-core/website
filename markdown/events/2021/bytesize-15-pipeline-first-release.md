...
[12:27](https://youtu.be/1OwkTd-P5pQ?list=PL3xpfTVZLcNiSvvPWORbO32S1WDJqKp1e&t=747) There are a couple of extra things that you can follow up on. You likely want to do subsequent releases of your pipeline, and there’s a [tips and tricks section](https://nf-co.re/contributing/adding_pipelines#subsequent-releases) on the nf-core website, that’s specifically targeted at this. There’s also an [extra guide](https://nf-co.re/contributing/adding_pipelines#adding-new-pipeline-features-to-existing-pipelines) on adding features to existing pipelines.

[13:10](https://youtu.be/1OwkTd-P5pQ?list=PL3xpfTVZLcNiSvvPWORbO32S1WDJqKp1e&t=790) So most of what I’ve talked about is based on two how-to guidelines on the nf-core homepage (<https://nf-co.re/contributing/adding_pipelines#making-the-first-release> and <https://nf-co.re/contributing/release_checklist>), so do check those out.
