...
🖊 "Draw stuff good: how to use Inkscape" by [Zandra Fagernäs](https://twitter.com/ZandraSelina)<br>
🚇 "Creating pipeline diagrams in Inkscape (like that [fancy metro-map](https://raw.githubusercontent.com/nf-core/eager/master/docs/images/usage/eager2_metromap_complex.png) one)" by [James Fellows Yates](https://github.com/jfy133)<br>
📊 "Pimp your MultiQC report" by [Phil Ewels](https://github.com/ewels)<br>
