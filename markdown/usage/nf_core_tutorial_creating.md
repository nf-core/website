...
subtitle: Tutorial covering the basics of creating nf-core pipelines.
---
...
Another tutorial about [using nf-core pipelines](nf-core_tutorial_using.md) is available.
...
* [2 - creating pipelines](#exercise-creating-pipelines)
* [3 - testing pipelines](#exercise-testing-pipelines)
* [4 - releasing pipelines](#exercise-releasing-pipelines)
...
This tutorial attempts to give an overview of how _nf-core_ works: how to make new pipelines using the _nf-core_ template and how _nf-core_ pipelines are reviewed and ultimately released.
...
As you are actively developing pipeline code, we recommend running Nextflow [locally](https://www.nextflow.io/docs/latest/getstarted.html#your-first-script).
For example:
...
### Setting up Docker and GitHub Actions
...
GitHub Actions should be already available on your GitHub account.

### Exercise (creating pipelines)
...
I hope that this _nf-core_ tutorial has been helpful!
