...
- In case it is not possible to add test data for some modules which require a local database, it is recommended that you use the [`stub feature`](https://www.nextflow.io/docs/latest/process.html#stub) in Nextflow to create a `stub` for the database. Please refer to the [`gtdbtk/classify`](https://github.com/nf-core/modules/blob/79d38a306bdaf07000e0d6f300684d3ed38c8919/modules/gtdbtk/classifywf/main.nf#L66) module and its corresponding [test module](https://github.com/nf-core/modules/blob/79d38a306bdaf07000e0d6f300684d3ed38c8919/tests/modules/gtdbtk/classifywf/main.nf#L20) to understand how to use this feature in module development.
