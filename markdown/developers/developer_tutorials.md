...
- [Tutorial: nf-core contributor overview](tutorials/nf_core_contributing_overview.md)
  - An overview on contributing to nf-core, starting with installing nf-core tools, creating a new pipeline using the nf-core template, adding modules to it and releasing.
