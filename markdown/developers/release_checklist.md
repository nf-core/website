...
A number of events are automatically triggered after the pipeline is released:
  ...
  * The [nf-core Twitter](https://twitter.com/nf_core) account will send out an automateed tweet about the pipeline release within minutes.
  * A [Zenodo DOI](https://zenodo.org/) is automatically generated that provides a means with which to cite the pipeline.
    * After the first release of the pipeline you will need to add this information manually into the main `README.md` for the pipeline.
