...
> ⚠️ Please make sure to check for any attributions to be included within any derivative images, as defined by the corresponding license!
> 
>  Typically attributions can be listed as `Design originally by <original author>`
