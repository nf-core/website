...
- [modules_structure](modules_structure)
  - [`PipelineLint.modules_structure()`](modules_structure#nf_core.lint.PipelineLint.modules_structure)
- [multiqc_config](multiqc_config)
  - [`PipelineLint.multiqc_config()`](multiqc_config#nf_core.lint.PipelineLint.multiqc_config)
...
- [system_exit](system_exit)
  - [`PipelineLint.system_exit()`](system_exit#nf_core.lint.PipelineLint.system_exit)
