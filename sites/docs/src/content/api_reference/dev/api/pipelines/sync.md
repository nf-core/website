...
### _`class{:python}`_`nf_core.pipelines.sync.PipelineSync(pipeline_dir, from_branch=None, make_pr=False, gh_repo=None, gh_username=None, template_yaml_path=None, force_pr=False){:python}`
