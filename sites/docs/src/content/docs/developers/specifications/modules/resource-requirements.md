...
You MUST provide an appropriate resource `label` for the module as listed in the [nf-core pipeline template](https://github.com/nf-core/tools/blob/master/nf_core/pipeline-template/conf/base.config#L29-L46). For example, `process_single`, `process_low`, `process_medium` or `process_high`.
