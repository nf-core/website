---
title: Institutional configs
subtitle: How to use nf-core's centralised institutional configs
shortTitle: Institutional configs
weight: 4
---
...
Here we describe the four things you need to do in your custom script or pipeline to use nf-core institutional configs.
