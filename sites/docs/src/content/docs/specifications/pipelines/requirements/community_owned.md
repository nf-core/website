...
This means that as people's time commitments and funding change, maintenance of a pipeline can shift between groups and stay up to date.
:::

By adding a pipeline to nf-core, you MUST agree to working in our collaborative ecosystem:
