...
Outside of the core colours, use of the [Bootstrap colour palettes](https://getbootstrap.com/docs/5.3/customize/color/):
...
:::note
See [full bootstrap colour description](https://getbootstrap.com/docs/5.3/customize/color/) for all colours.
:::
