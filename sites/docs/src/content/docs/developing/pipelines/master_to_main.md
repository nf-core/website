...
subtitle: Switch default branch to main
shortTitle: Renaming branches
---

<!-- TODO this should be moved to migration guides, as it's a one off step for older pipelines, not something we regularly do -->
