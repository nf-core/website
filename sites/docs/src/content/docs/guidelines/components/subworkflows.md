...
To maintain code quality and prevent issues, all code MUST be free of Nextflow warnings and errors. Utilize the following command to check your code: `nextflow lint subworkflows/nf-core/module_name`.
