...
shortTitle: create
weight: 60
import features from '../../../../pages/docs/nf-core-tools/features.astro'
---
...
If you prefer, you can supply them as command line arguments. See `nf-core pipelines create --help` for more information.
...
The interface will guide you through the pipeline creation process. Both nf-core and non-nf-core pipelines can be customised, but non-nf-core pipelines have more options which can be skipped. An example of a `template.yml` file is shown below.
