...
Generate and update a RO Crate using the `nf-core pipelines rocrate` command.
This runs automatically with `nf-core pipelines create` and `nf-core pipelines sync`.
