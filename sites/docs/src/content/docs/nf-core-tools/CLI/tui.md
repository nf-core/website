...
The `nf-core` command-line interface is fairly large, with many commands and options. To make it easier to explore and use, run `nf-core interface` to launch a graphical terminal interface.
