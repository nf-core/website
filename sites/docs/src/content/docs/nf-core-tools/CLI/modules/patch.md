...
If you want to make a minor change to a locally installed module but still keep it up to date with the remote version, you can create a patch file using `nf-core modules patch`.
