...
If a bio.tools entry is found, the command will try to guess the correct input and output channels and ontologies for you. Make sure to check if the given information is correct.
