---
title: Write nf-core components
subtitle: Tutorial for DSL2 modules and subworkflows
shortTitle: Write nf-core components
weight: 20
---
...
10. Check that the new module you've added follows the [module specifications](/docs/guidelines/components/modules)
