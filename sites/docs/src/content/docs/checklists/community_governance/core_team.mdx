...
2. [ ] Transfer the repository to the nf-core organisation.
    ...
    5. Add core team (admin access) and contributors (write access) to have right access
...
4. [ ] Add lead devs of the pipeline as collaborators with 'maintain' rights (Settings > Access > Collaborators and Teams > Manage Access)
