...
9. [ ] Core/Dev: Was the development started in a custom (non nf-core) repo?
    9.1. YES: [Transfer the repository](https://nf-co.re/docs/checklists/community_governance/core_team#repository-transfer-to-nf-core-organisation) to nf-core.
    9.2. NO: Create a new GitHub repository with the name of the pipeline.
...
10. [ ] Core/Dev: After first release, remove the pipeline name from the [website YAML file](https://github.com/nf-core/website/blob/75a92b76129b0e2c3f644bf26482142ba9e41f6f/sites/main-site/src/config/ignored_repos.yaml) ignoring this pipeline from the build, if it is there.
