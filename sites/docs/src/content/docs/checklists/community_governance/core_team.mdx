...
6. [ ] Core: Verify that the pipeline name follows the [pipeline naming guidelines](/docs/guidelines/pipelines/requirements/workflow_name).
7. [ ] Core: Create a slack channel with approved pipeline name.
8. [ ] Core: Add the main developers to [#pipeline-maintainers](https://nfcore.slack.com/archives/C04QR0T3G3H) channel.
...
12. [ ] Core: Create a branch with the pipeline name in the [nf-core/test-datasets](https://github.com/nf-core/test-datasets) repository.
