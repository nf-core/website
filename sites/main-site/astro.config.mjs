...
pipelines_json.remote_workflows.map((pipeline) => {
    const latestRelease = pipeline.releases[0].tag_name;
    ...
    pipelineRedirects[`/${pipeline.name}/docs/*`] =
        `https://nf-core-pipelines.netlify.app/${pipeline.name}/${latestRelease}/docs/:splat 200!`;
