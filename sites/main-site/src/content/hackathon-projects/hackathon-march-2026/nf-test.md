...
This project aims to update and fix several bugs and issues in the [nf-test](https://github.com/askimed/nf-test) codebase, which is used for testing nf-core pipelines.

## Goal

Work on resolving nf-test issues and add new features to the codebase.
