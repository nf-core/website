...
<div class="d-flex justify-content-between pt-4 my-5">
    ...
    <div class="text-center" style="width:300px">
        <Image src={event2018Hack} alt="Attendees at an early nf-core hackathon" width={260} class="mb-2" />
        <p>
            <strong>2018</strong>
        </p>
        <p>
    ...
    <div class="text-center" style="width:300px">
        <Image src={event2019Cook} alt="Early nf-core cooking event in Barcelona, 2019" width={260} class="mb-2" />
        <p>
            <strong>2019</strong>
        </p>
...
<div class="text-center my-3">
    <Image src={socksCollection} alt="nf-core socks collection" width={300} />
