...
![nf-core logo where "core" is replaced with "lore"](../../assets/images/lore.svg)
...
There exists a Nextflow workflow that you can run called `socks`. While many sock traditions may predate this workflow, it stands as a testament to how deeply embedded sock culture is in our community.
