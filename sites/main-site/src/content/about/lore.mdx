...
Custom Nextflow and Seqera themed socks continue to be created for major events like the Nextflow Summit. Some community members maintain impressive collections — the "Novelty Nextflow Socks" drawer is a real thing, and it's probably fuller than you think <Image src={socksCollection} alt="nf-core socks" width={20} height={20} style={{display: "inline"}} />.
