...
<div class="d-flex justify-content-between border-top pt-4 my-5">

  <div class="text-center" style="width:180px">
    <Image src={event2018Intro} alt="nf-core concept introduced at the 2018 Nextflow User Meeting in Barcelona" width={120} class="rounded-circle mb-2" />
    <p><strong>2018</strong></p>
    <p>The concept for nf-core is introduced for the first time at the 2018 Nextflow User Meeting in Barcelona</p>
  </div>

  <div class="text-center" style="width:180px">
    <Image src={event2018Hack} alt="Attendees at an early nf-core hackathon" width={120} class="rounded-circle mb-2" />
    <p><strong>2018</strong></p>
    <p>Attendees at an early nf-core hackathon. Imagine all attendees for nf-core hackathons trying to fit in one picture now!</p>
  </div>

  <div class="text-center" style="width:180px">
    <Image src={event2019Cook} alt="Early nf-core cooking event in Barcelona, 2019" width={120} class="rounded-circle mb-2" />
