...
2. <i class="fab fa-slack"></i> Join the relevant Slack channel(s) to stay up to date and discuss with your project
   members. - [Beginners channel](https://nfcore.slack.com/archives/C06NEGANQ2J) - [Infrastructure
   channel](https://nfcore.slack.com/archives/C06P9UX9T5W) - [Modules & subworkflows
   channel](https://nfcore.slack.com/archives/C06P9UP3K4G) - [nf-test
   channel](https://nfcore.slack.com/archives/C06NPK4J2GL) - [Pipelines
   channel](https://nfcore.slack.com/archives/C06NM5GDP5Y) - [Training materials
   channel](https://nfcore.slack.com/archives/C06NM2HM6MR) - [Scavenger hunt
   channel](https://nfcore.slack.com/archives/C06P39LTE4W)
