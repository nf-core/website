...
Beginners are welcome, but this is not a training event.
_(There is a separate [training event](https://summit.nextflow.io/2024/barcelona/training/) in parallel to the hackathon.)_
