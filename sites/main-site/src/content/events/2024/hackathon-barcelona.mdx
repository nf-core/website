...
<HackathonGroup title="Image processing pipelines" color="#238636" leaders={{'kbestak': 'Kresimir Bestak'}}>
    This project focuses on creating modules and adding functionality to (highly multiplexed) imaging pipelines - [nf-core/mcmicro](https://nf-co.re/mcmicro) and [nf-core/molkart](https://nf-co.re/molkart) such as:
    By joining this group you can:
