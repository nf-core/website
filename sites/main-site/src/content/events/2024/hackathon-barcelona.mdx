...
<HackathonGroup title="Image processing pipelines" color="#238636" leaders={{'kbestak': 'Kresimir Bestak'}}>
...
<HackathonGroup title="nf-core/deepmodeloptim" color="#238636" leaders={{'mathysgrapotte': 'Mathys Grapotte'}}>
...
<HackathonGroup title="Meta-omics" color="#238636" leaders={{'erikrikarddaniel': 'Daniel Lundin', 'jfy133': 'James Fellows Yates'}}>
...
<HackathonGroup title="Sarek (preprocessing) goes GPU" color="#238636" leaders={{'Furentsu': 'Eugenio Franzoso', 'famosab': 'Famke Bäuerle'}}>
...
<HackathonGroup title="nf-core/genomeqc" color="#238636" leaders={{'chriswyatt1': 'Chris Wyatt', 'GallVp': 'Usman Rashid', 'FernandoDuarteF': 'Fernando Duarte', 'mahesh-panchal': 'Mahesh Binzer-Panchal'}}>
