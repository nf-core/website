...
2. <i class="fab fa-slack"></i> Join the relevant Slack channel(s) to stay up to date and discuss with your project
   members. - [#hackathon-may-2024](https://nfcore.slack.com/archives/C074MJ1PLKA) **(everyone should join this
   channel)** - [#hackathon-may-2024-nf-test](https://nfcore.slack.com/archives/C074BEKHFMF) -
