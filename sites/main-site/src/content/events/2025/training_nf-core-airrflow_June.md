...
The workshop will start with an introduction to nf-core/airrfow, including newly implemented features, and a hands-on session on how to run the workflow with example data, following the [nf-core/airrflow single-cell tutorial](https://nf-co.re/airrflow/docs/usage/single_cell_tutorial).
...
Please register in advance using the following link: <link to survey>

There are a maximum of 20 slots for the training, so please only register if you plan to attend.

The workshop will be hosted online via [zoom.us](https://zoom.us), with the specific link being sent out via email on registration.
