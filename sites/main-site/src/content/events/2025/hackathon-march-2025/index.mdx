...
- Daily wrap-up
    - APAC: 5pm NZDT / 3pm AEDT (<LocalDateTime date={new Date(1742788800000)} date_options={{ hour: "2-digit", minute: "2-digit" }} client:visible />)
    - EMEA: 5pm CET / 4pm GMT (<LocalDateTime date={new Date(1742832000000)} date_options={{ hour: "2-digit", minute: "2-digit" }} client:visible />)
    - AMER: 5pm ET / 2pm PDT (<LocalDateTime date={new Date(1742850000000)} date_options={{ hour: "2-digit", minute: "2-digit" }} client:visible />)
- Quiz social
    - Tuesday 25th March, 4pm CET / 11am ET / 8am PDT (<LocalDateTime date={new Date(1742914800000)} date_options={{ hour: "2-digit", minute: "2-digit" }} client:visible />)
    - Tuesday 25th March, 5pm PDT / 1pm NZDT / 11am AEDT (<LocalDateTime date={new Date(1742947200000)} date_options={{ hour: "2-digit", minute: "2-digit" }} client:visible />)
