...
import HackathonProjectList from '@components/event/HackathonProjectList.astro';
...
If you have an idea for a project that you think would be fun to do during the hackathon, please submit it by opening a pull-request to add it to the [hackathon-projects collection](https://github.com/nf-core/website/tree/main/sites/main-site/src/content/hackathon-projects/hackathon-march-2025.yml).
The only required fields are `title`, `description` and `leaders`.
...
<HackathonProjectList eventPath="hackathon-march-2025" />
...
:notes: A community Spotify playlist was created during the first hackathon, and many songs have been added since

  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/nf-core/logos/master/nf-core-logos/nf-core-hackathon-playlist_dark.png"></source>
    <img alt="nf-core/sarek" src="https://raw.githubusercontent.com/nf-core/logos/master/nf-core-logos/nf-core-hackathon-playlist_light.png"></img>
  </picture>
