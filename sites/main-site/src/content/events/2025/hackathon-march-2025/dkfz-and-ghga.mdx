    ...
    <table class="table table-hover table-sm table-bordered">
        <thead>
            ...
            <tr>
                ...
                <td background-color:navy; rowspan="1">Arrival:<br>Heidelberg</td>
                <td background-color:navy; rowspan="1">Arrival:<br>Heidelberg</td>
                <td background-color:navy; rowspan="1">Arrival:<br>Heidelberg</td>
            </tr>
            <tr>
            ...
            <tr>
                <td data-timestamp="1679869800" data-timeformat="HH:mm z">12:00</td>
            ...
            <tr>
                ...
                <td>Daily sync<br>Location: Heidelberg</td>
                <td>Daily sync<br>Location: Heidelberg</td>
                <td>Final wrap-up<br>Location: Heidelberg</td>
            </tr>
            <tr>
                <td data-timestamp="1679936400"  data-timeformat="HH:mm z">19:00</td>
                <td>Social Dinner<br>Location: TBD</td>
                <td>Seqera Pizza Dinner<br>Location: Mathematikon, Berliner Straße 41, 2nd floor.</td>
                <td></td>
            </tr>
        </tbody>
    </table>
...
<div style="text-align: center;">
    ...
    <img src="https://nct.dkfz.de/typo3conf/ext/sitepackage/Resources/Public/Images/logo_nct_en.png" width=200>
</div>
