...
hackathonProjectListModals: hackathon-boston-2026
---

import { Image } from "astro:assets";
import summitCard from "@assets/images/events/2026/hackathon-boston/summit-2026-boston.png";
...
- **Summit website**: https://summit.nextflow.io/2026/boston/
- **Dates**: 28th - 29th April 2026
- **Registration**: Visit the [summit registration page](https://summit.nextflow.io/2026/boston/register/)
- **Location**: [Aloft Boston Seaport District](https://www.marriott.com/en-us/hotels/bosal-aloft-boston-seaport-district/overview/)

<a href="https://summit.nextflow.io/2026/boston/register/">
    <Image class="mb-5" src={summitCard} alt="Nextflow Summit 2026 - Boston" />
</a>
...
- [`#hackathon-apr-2026`](https://nfcore.slack.com/channels/hackathon-mar-2026) - Main hackathon communication
...
[`sites/main-site/src/content/hackathon-projects/hackathon-boston-2026` directory](https://github.com/nf-core/website/tree/main/sites/main-site/src/content/hackathon-projects/hackathon-boston-2026).

See the [topics migration project markdown file](https://github.com/nf-core/website/blob/90e7e63a6e5ae196fc4a51319dc67c7795aca209/sites/main-site/src/content/hackathon-projects/hackathon-boston-2026/topics_migration.md) as an example, if you're unsure about anything please ask in Slack or in the pull-request.
...
- `slack`: If your project already has an obvious Slack channel (eg. a pipeline) then right click
  ...
  channel for your project with the pattern `#hack-boston-2026-<project-name>`.
- `image`: A meme, silly picture or any other image to make your project more memorable.
  Add to the [`sites/main-site/src/assets/images/events/2026/hackathon-boston` directory](https://github.com/nf-core/website/tree/main/sites/main-site/src/assets/images/events/2026/hackathon-boston)
  as part of your PR.
...
<HackathonModalProjectList eventPath="hackathon-boston-2026" />
