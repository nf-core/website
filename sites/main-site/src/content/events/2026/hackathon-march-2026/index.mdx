...
-   **February 2nd 2026**: Project proposals open
...
-   Having multiple leads coordinate different aspects of a project can help distribute the work across sites
...
You don't need to commit to a single project and are free to move between projects at your location (or online) throughout the event.
