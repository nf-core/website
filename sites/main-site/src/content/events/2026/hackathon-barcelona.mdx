...
- [`#hackathon-oct-2026`](https://nfcore.slack.com/archives/C0BKZMG6467) - Main hackathon communication
...
The hackathon will run from **Thursday 15th October** 9AM to **Friday 16th October** 5PM. At 10AM on Friday there will be the traditional nf-core Quiz (don't forget to look up how to make links in markdown!).
More information, like a more detailed schedule can be viewed [here](https://summit.nextflow.io/2026/barcelona/agenda/).
