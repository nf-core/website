...
- Could we use an MCP agent to auto-annotate files with metadata as a first pass, some nf-core members have experience with these (<Profile username="itrujnara">Igor</Profile>)
