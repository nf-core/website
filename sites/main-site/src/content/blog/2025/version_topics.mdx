...
import topicteam from "@assets/images/blog/hackathon-topic/topics_team.jpg";

<Image src={topicteam} alt="Lots of fun hacking nf-core modules versions with topic :)." />
...
3. tests/main.nf.test
4. Update snapshot
5. fix nf-core/subworkflows
