...
import topicmeme from "@assets/images/blog/hackathon-topic/topic_versions.png";
...
<Image
    ...
    width={400}
    density={[1.5, 2]}
    alt="potus holding up a folder with two pages. Left one saying 'version.yml files are banned', right one saying 'use topic channels'"
/>
...
You can update the meta.yml conveniently using   
 ```nf-core modules <MODULE_NAME> lint --fix```
