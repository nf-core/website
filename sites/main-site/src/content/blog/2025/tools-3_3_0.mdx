...
```bash
nf-core test-datasets <subcommand>
```
...
See the full docs for the `test-datasets list` command [here](https://nf-co.re/docs/nf-core-tools/test-datasets/list), and the `test-datasets search` command [here](https://nf-co.re/docs/nf-core-tools/test-datasets/search).
