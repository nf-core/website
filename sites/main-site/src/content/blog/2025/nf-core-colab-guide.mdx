...
In this blog post we provide background into our own experiences of running and developing Nextflow and nf-core pipelines, describing its pros and cons, but that also motivated the creation of the tutorial. Make sure to give it a look to see if this approach suits your needs.
...
This is because `sudo` access is needed to install the these engines.
...
Once you've got your Nextflow, conda, and nf-core pipeline of your choice installed you're pretty much good to go to run any pipeline you desire.
