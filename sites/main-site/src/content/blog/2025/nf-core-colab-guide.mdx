...
```python title="Authenticate with GitHub"
vscode_colab.login()
```
...
<Image
    ...
    width={800}
    density={[1.5, 2]}
    alt="interactive login popup in cell output"
/>
...
```python title="Establish the tunnel"
...
<Image
    ...
    width={800}
    density={[1.5, 2]}
    alt="interactive tunnel connection popup in cell output"
/>
...
```python title="Mount Google Drive"
