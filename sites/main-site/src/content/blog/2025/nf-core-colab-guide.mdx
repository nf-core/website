...
Additionally, if you plan on writing and developing your pipelines exclusively in Google Colab, then make sure to work in `git` and regularly commit and push, or alternatively test in Colab but save changes from your local PC and commit to prevent loss of your progress.
