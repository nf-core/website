...
headerImageAlt: "A path in the middle of a gree forest"
...
This bio.tools ID opened new possibilities, such as being able to grab the inputs and outputs of that tool and find the ontology terms for input and output files.
...
The `key` describes the type of ontology (currently using [EDAM ontology](https://edamontology.github.io/edam-browser/#topic_0091)),
