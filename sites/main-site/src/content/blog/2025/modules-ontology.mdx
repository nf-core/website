...
Nf-core moduels come with a `meta.yml` file used to describe the structure of that module.
...
This let to issues such as missing descriptions for multiple meta maps or difficulting the identification of different channels.
