...
import advisoryfooter from "@assets/images/blog/announcement_advisories/advisories-wilhelm-busch-style-footer.png";
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-wrap gap-1">
                            <span class="badge text-bg-warning text-small">
                                <i class="fas fa-exclamation-triangle me-1" aria-hidden="true"></i>Known Regression
                            </span>
                        </div>
                        <div class="d-flex">
...
The collapsible "Tip" section below provides a reference for the supported categories and valid specifications - you can find [the same summary also on the website's README](https://github.com/nf-core/website?tab=readme-ov-file#adding-an-advisory).
...
<Image
    ...
    width={510}
    density={[1.5, 2]}
    alt="An old-fashioned, sepia tone Wilhelm Busch-style caricature of a woman sitting in a vintage armchair, reading a newspaper. The woman is depicted in a comically exaggerated pose of shock and bewilderment — eyes wide, mouth agape. Small details like a side table with a lamp and a teacup are adding atmosphere. Drawn in the sketchy, ink-heavy, slightly chaotic style of 19th-century German caricatures."
/>
