...
- In March 2026, we'll start to introduce out strict syntax for pipelines with workflow outputs and inputs.
- In March 2027, we'll start to introduce out static types with new process syntax.

```mermaid
%%{init: {'theme':'base', 'themeVariables': {'fontSize':'12px'}, 'gantt': {'useWidth':600, 'topAxis': false}}}%%
gantt
    ...
    section Phase 3
    Static types with new process syntax :2027-03, 12M
```
...
Stay tuned to the [`#announcements`](https://nfcore.slack.com/archives/CE6P95170) in Slack and the blog for updates as these initiatives roll out. And as always, thank you to everyone who contributes to making nf-core what it is.

<Image
    src={aifur}
    alt="Much fun was had at the viking-themed restaurant Aifur in Stockholm."
/>
