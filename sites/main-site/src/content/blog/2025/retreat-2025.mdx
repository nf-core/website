...
```mermaid
%%{init: {'themeVariables': {'fontSize':'12px'}, 'gantt': {'useWidth':600, 'topAxis': false}}}%%
gantt
...
Stay tuned to the [`#announcements`](https://nfcore.slack.com/archives/CE6P95170) channel in Slack and the blog for updates as these initiatives roll out. And as always, thank you to everyone who contributes to making nf-core what it is.
