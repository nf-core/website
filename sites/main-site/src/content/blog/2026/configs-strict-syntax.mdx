...
pubDate: 2026-03-02T12:00:00+01:00
authors:
    - @nvnieuwk
    - @jfy133
label:
...
2. Post (this!) blog post for outside visibility, but also a cross cross-reference on the nf-core Slack's [#announcements](https://nfcore.slack.com/archives/CE6P95170) channel
