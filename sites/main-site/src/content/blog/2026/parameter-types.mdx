...
import bicycle from "../../../assets/images/blog/parameter-types/parameter-types-bicycle.jpg";
import frog from "../../../assets/images/blog/parameter-types/parameter-types-frog.jpg";
...
<Image
    ...
    width={400}
    density={[1.5, 2]}
    alt="A meme showing a man riding a bicycle and putting a stick in his wheel. This symbolizes the experience of bumping to Nextflow 26.04.0"
/>
...
<Image
    ...
    width={400}
    density={[1.5, 2]}
    alt="A toad wearing a tuxedo proudly announcing that this pipeline uses parameter types"
/>