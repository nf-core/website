...
The [first module migration was](https://github.com/nf-core/modules/pull/3938) in October 2023, and we started.

At this point, there were over 937 modules/subworkflows in the nf-core/modules repository. Two years later, after two Hackathon and multiple contribution from all over the world, the [last subworkflow was migrated](https://github.com/nf-core/modules/pull/8962) and the modules repository is now nf-test only!
...
![pytest_modules_over_time](https://hackmd.io/_uploads/rJEuZ03w-l.png)
