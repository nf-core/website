...
headerImage: /assets/images/blog/modules-pytest-conversion/modules-over-time.png
headerImageAlt: Number of pytests in the nf-core modules repository over time
authors:
    - sppearce
    - LouisLeNezet
label:
...
- Fixing all Nextflow linting (strict syntax)
