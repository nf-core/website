...
| `conda_env`            | <span class="badge text-bg-success">New</span>         | Conda environments with local environment resolution                               |
...
| `mamba_env`            | <span class="badge text-bg-success">New</span>         | Conda environments with local environment resolution, using Mamba                  |
