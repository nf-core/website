...
{/* TODO: UPDATE PERMALINK WHEN NO LONGER AN MD5 */}
...
4. GitHub Actions runs stub tests commits the updated the
   [version snapshot](https://github.com/nf-core/modules/blob/5c2ab5de7e8de33ac7cab83a4cd28a4d29a84049/modules/nf-core/bowtie2/align/tests/main.nf.test.snap#L169-L186).
...
([example shown for bowtie2](https://github.com/nf-core/modules/blob/5c2ab5de7e8de33ac7cab83a4cd28a4d29a84049/modules/nf-core/bowtie2/align/tests/main.nf.test.snap#L169-L186)):
