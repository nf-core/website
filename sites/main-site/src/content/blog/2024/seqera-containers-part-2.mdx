...
4. GitHub Actions runs tests to verify the updates and bumps the
   [version snapshot](https://github.com/nf-core/modules/blob/ff06c3314e33653dd948225af2b565cc48a3c18b/modules/nf-core/ale/tests/main.nf.test.snap#L26-L28).
