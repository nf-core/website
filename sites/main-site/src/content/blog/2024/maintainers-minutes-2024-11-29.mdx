...
tests execute that were implemented over a couple of weeks in November by a small team including himself, <Profile username="edmundmiller">Edmund Miller</Profile>
