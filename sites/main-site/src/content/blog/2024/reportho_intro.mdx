...
headerImage: '/assets/images/blog/reportho_intro/reportho_tube_map.png'
...
# The Nightmare
<Image class="d-block m-auto" src={train_tracks} alt="A very complicated layout of railway tracks with multiple signs and signals" />
...
# The Dream
<Image class="d-block m-auto" src={the_world_if} alt="A futuristic city with flying vehicles, captioned in boldface with 'The world if reportho'" />
...
The pipeline has already had its first release and is available on (the website)[nf-co.re/reportho]. We have many ideas to expand the pipeline, but we need your feedback to make it exactly what you need. Try the pipeline today, enjoy hassle-free ortholog research, and make sure to send us your thoughts!
