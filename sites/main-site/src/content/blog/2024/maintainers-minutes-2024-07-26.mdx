...
However, it was brought up that linting against the tools dev version may cause problems with changes that may occur during the development on the dev branch.
