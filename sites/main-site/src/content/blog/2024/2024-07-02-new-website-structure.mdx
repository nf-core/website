...
headerImage: 'https://images.unsplash.com/photo-1514497158453-f759c32a27fe'
headerImageAlt: 'Aerial top down view of an icy forest split vertically by a river or street in the middle with the left side appearing more gray compared to the whiter right side.'
authors:
    - 'mashehu'
label:
    - 'website'
...
Instead of running the development server with `npm run dev` you need to now run it for a specific sub-site, for example:
