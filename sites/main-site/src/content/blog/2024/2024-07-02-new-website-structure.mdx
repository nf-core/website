...
---
xychart-beta
    x-axis "sites" ["old structure","old structure Astro 4", "sites/configs", "sites/docs", "sites/main-sites", "sites/pipelines", "sites/pipelin-releases"]
    y-axis "average build times [in minutes]" 0.5 --> 20
    bar [8, 18, 0.85, 1.5, 1.85, 4.3, 1.5]
    bar [0, 0, 0.85, 1.5, 1.85, 4.3, 1.5]
```
