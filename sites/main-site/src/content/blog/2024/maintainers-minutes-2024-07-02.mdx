...
🤔 However given the burning need by the community to have such functionality, we decided to set up the first (of two!) 'working groups', let by Rike (@FriederikeHanssen), to address this question. Feel free to join [#wg-meta-pipelines](https://nfcore.slack.com/archives/C07B5FK9GKA) join in.
