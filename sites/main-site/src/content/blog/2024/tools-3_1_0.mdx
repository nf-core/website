...
-   `main` now allowed as the default release branch for pipelines. With this release we extended the template and tooling to support either `main` or `master` as the default branch for pipelines.
