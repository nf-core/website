...
<Image
    ...
    width={400}
    density={[1.5, 2]}
    alt="London Underground style 'tube map' showing how potentially nf-core pipelines can be used for complementary and sequential analysis within meta-omics disciplines"
/>
