...
9. Check that the new module you've added follows the [module specifications](/docs/guidelines/components/modules)
...
9. Check that the new subworkflow you've added follows the [subworkflow specifications](/docs/guidelines/components/subworkflows)
