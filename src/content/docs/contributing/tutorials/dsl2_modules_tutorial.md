...
PROFILE=docker pytest --tag fgbio/fastqtobam --symlink --keep-workflow-wd
```
...
```bash
cd /path/to/git/clone/of/nf-core/modules/
TMPDIR=~ PROFILE=singularity pytest --tag fgbio/fastqtobam --symlink --keep-workflow-wd
```
...
```bash
cd /path/to/git/clone/of/nf-core/modules/
PROFILE=conda pytest --tag fgbio/fastqtobam --symlink --keep-workflow-wd
```
...
```bash
NXF_VER="22.10.1" PROFILE=docker pytest --tag fgbio/fastqtobam --symlink --keep-workflow-wd
```
