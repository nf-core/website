...
1. [ ] Add self profile to the [About > Governance > Maintainers section](https://nf-co.re/governance#maintainers)
...
5. [ ] Move members who step down to alumni status on the website in the [About > Governance > Maintainers section](https://nf-co.re/governance#maintainers)
