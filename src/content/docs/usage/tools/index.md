...
![`nf-core list`](/images/tools/nf-core-list.svg)
...
![`nf-core list rna rna-seq`](/images/tools/nf-core-list-rna.svg)
...
![`nf-core list -s stars`](/images/tools/nf-core-list-stars.svg)
...
![`nf-core download rnaseq -r 3.8 --outdir nf-core-rnaseq -x none -s none -d`](/images/tools/nf-core-download.svg)
...
![`nf-core modules remove abacas`](/images/tools/nf-core-modules-remove.svg)
