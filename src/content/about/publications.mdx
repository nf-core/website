...
:::info{title="The nf-core framework for community-curated bioinformatics pipelines"}
...
:::info{title="nf-core: Community curated bioinformatics pipelines"}
...
:::info{title="Workflow systems turn raw data into scientific knowledge"}
...
:::info{title="Interpretations of Environmental Microbial Community Studies Are Biased by the Selected 16S rRNA (Gene) Amplicon Sequencing Pipeline"}
...
:::info{title="CoproID predicts the source of coprolites and paleofeces using microbiome composition and host DNA content"}
...
:::info{title="DIAproteomics: A Multifunctional Data Analysis Pipeline for Data-Independent Acquisition Proteomics and Peptidomics"}
...
:::info{title="Reproducible, portable, and efficient ancient genome reconstruction with nf-core/eager"}
...
:::info{title="hgtseq: A Standard Pipeline to Study Horizontal Gene Transfer"}
...
:::info{title="HiCAR is a robust and sensitive method to analyze open-chromatin-associated genome organization."}
...
:::info{title="Characterisation of tumour microenvironment remodelling following oncogene inhibition in preclinical studies with imaging mass cytometry."}
...
:::info{title="LncPipe: A Nextflow-based pipeline for identification and analysis of long non-coding RNAs from RNA-Seq data."}
...
:::info{title="nf-core/mag: a best-practice pipeline for metagenome hybrid assembly and binning"}
...
:::info{title="MHCquant: Automated and Reproducible Data Analysis for Immunopeptidomics"}
...
:::info{title="A systematic benchmark of Nanopore long read RNA sequencing for transcript level analysis in human cell lines"}
...
:::info{title="Sarek: A portable workflow for whole-genome sequencing analysis of germline and somatic variants** [version 2; peer review: 2 approved"}
...
:::info{title="scFlow: A Scalable and Reproducible Analysis Pipeline for Single-Cell RNA Sequencing Data"}
