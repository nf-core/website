...
* **Parameters:**
  * **pipeline\_obj** ([*nf\_core.utils.Pipeline*](utils#nf_core.utils.Pipeline)) – A Pipeline object that holds information
    about the pipeline contents and build files.
  * **new\_version** (*str*) – The new version tag for the required Nextflow version.
...
* **Parameters:**
  * **pipeline\_obj** ([*nf\_core.utils.Pipeline*](utils#nf_core.utils.Pipeline)) – A Pipeline object that holds information
    about the pipeline contents and build files.
  * **new\_version** (*str*) – The new version tag for the pipeline. Semantic versioning only.
...
* **Parameters:**
  ...
  * **pipeline\_obj** ([*nf\_core.lint.PipelineLint*](lint#nf_core.lint.PipelineLint)) – A PipelineLint object that holds information
    about the pipeline contents and build files.
