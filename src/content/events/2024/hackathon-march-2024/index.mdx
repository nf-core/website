...
::: info
If you can't host a site, but want to check if others in your area are considering it, post on the main hackathon Slack channel [`hackathon-mar-2024`](https://nfcore.slack.com/archives/C06GNCNARS5).
:::
