...
The agenda is outlined on the the [Nextflow Summit website](https://summit.nextflow.io/boston/agenda/hackathon/#events).
...
<HackathonGroup title="Modules & Subworkflows" color="#1f6feb" intro_video="Lv2vCLJ2xiM" proj_url="https://github.com/orgs/nf-core/projects/47/views/5" slack="#hackathon-nov-2023-modules" leaders={{
...
Kick back and relax with fellow Hackathoners at [Cheeky Monkey Brewery](https://www.bowlero.com/cheeky-monkey-brewing).
...
[Cheeky Monkey Brewery](https://www.bowlero.com/cheeky-monkey-brewing) is a 30 min walk or 8 min drive from the Hilton Boston Park Plaza hotel.
