...
However, it works great as a generic variant calling pipeline and indeed many groups use
...
including GEroNIMO, AQUA-FAANG, GENE-SWitCH, Rumigen and HoloRuminant.
