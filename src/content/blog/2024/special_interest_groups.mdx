...
pubDate: 2024-03-02T00:00:00+01:00
#pubDate: 2024-03-12T00:00:00+01:00
...
import cross_functional from '@assets/images/blog/special_interest_groups/cross-functional-organisation.png';
...
Until now, the nf-core has been very focussed on doing what we do best:
...
Different research projects can use the _same_ set of pipelines in very different ways:
for example [nf-core/sarek](/sarek) was primarily written for analysis of somatic
cancer sequencing analysis, with tumor:normal Human DNA samples as inputs – however
it works great as a generic variant calling pipeline and indeed many groups use
...
We see more and more large research consortia adopting nf-core pipelines for their
...
-   This process will be tracked in a GitHub project, called [New interest groups](#)
    {/* - TODO: Fill in the link above */}
...
<Image src={cross_functional} alt="Cross-functional pipelines and interest group structure" />

# Introducing: Our first special interest group

Today we are delighted to announce our first interest group: _Domestic animal genomics_.
...
This interest group has formed out of the BovReg and EuroFAANG research consortia.
BovReg has been working closely with nf-core since its inception.
{/* TODO: Add full names of BovReg and EuroFAANG, tagline etc. */}
It's part of the larger EuroFAANG consortium and has helped bring other groups
in to using nf-core pipelines, including XXX, YYY, ZZZ.
{/* - TODO: Add names of other EuroFAANG consortia who started using nf-core */}
