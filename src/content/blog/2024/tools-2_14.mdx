...
-   The `nf-core download` command has a new argument `--tag` which allows adding with additional tags to select particular revisions in the Seqera Platform interface.
