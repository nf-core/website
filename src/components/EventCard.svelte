             ...
             {#if time_category === 'current'}
                <div class="dropwdown btn-group float-end" role="group">
                    ...
                    <div class="dropdown-menu text-secondary">
                        {#if typeof frontmatter.location_url === 'string'}
                            <a class="dropdown-item" href={frontmatter.location_url} target="_blank" rel="noreferrer"> {frontmatter.location_url} </a>
                        {:else}
            ...
            <div class="btn-group" role="group" aria-label="Basic example">
                ...
                <div class="dropwdown btn-group" role="group">
                    ...
                    <div class="dropdown-menu">
                        <span class="dropdown-item" on:click={()=>downloadIcal()}> Download iCal Event</span>
                        <a class="dropdown-item" href={googleCalendar} target="_blank"> Add to Google Calendar</a>
                        <a class="dropdown-item" href={outlookCalendar} target="_blank"> Add to Microsoft Outlook</a>
                    </div>
                </div>
                {/if}
            </div>
